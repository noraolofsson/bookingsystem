error id: file://<WORKSPACE>/src/main/java/com/example/bookingsystem/controller/BookingController.java
file://<WORKSPACE>/src/main/java/com/example/bookingsystem/controller/BookingController.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/example/bookingsystem/controller/BookingController.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/bookingsystem/controller/BookingController.java