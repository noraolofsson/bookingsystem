error id: file://<WORKSPACE>/src/main/java/com/example/bookingsystem/dto/BookingRequest.java.java
file://<WORKSPACE>/src/main/java/com/example/bookingsystem/dto/BookingRequest.java.java
...
```java
offset: 22
uri: file://<WORKSPACE>/src/main/java/com/example/bookingsystem/dto/BookingRequest.java.java
text:
```scala
class `BookingRequest.@@java` {
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/bookingsystem/dto/BookingRequest.java.java